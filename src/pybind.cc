...
TORCH_LIBRARY(gs_classes, m) {
  m.class_<Graph>("Graph")
      ...
      .def("_CAPI_SetEdgeBptr", &Graph::SetEdgeBptr)
      .def("_CAPI_SetColBptr", &Graph::SetColBptr)
      .def("_CAPI_SetRowBptr", &Graph::SetRowBptr)
      .def("_CAPI_BatchSetRows", &Graph::SetOrigRowIds)
      .def("_CAPI_BatchSetCols", &Graph::SetOrigColIds)
      .def("_CAPI_BatchGetRows", &Graph::BatchGetRows)
      .def("_CAPI_BatchGetCols", &Graph::BatchGetCols)
