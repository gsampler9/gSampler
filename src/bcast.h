 ...
 * \param lhs The left hand side operand of Tensor class.
 * \param rhs The right hand side operand of Tensor class.
 * \return the broadcast information of BcastOff class.
 */
BcastOff CalcBcastOff(const std::string& op, torch::Tensor lhs, torch::Tensor rhs);
